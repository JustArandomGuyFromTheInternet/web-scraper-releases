        ...
        for (const row of links) {
            ...
            if (isReel && IS_VISUAL_MODE) {
                ...
                try {
                    ...
                    await appendSheetsRow({ url, ...payload, likes: finalLikes, comments: finalComments, shares: finalShares, validation: aiData.validation || "Γ£ô" });
            ...
            try {
                ...
                if (IS_VISUAL_MODE) {
                    ...
                    await appendSheetsRow({
                        ...
                        shares: finalShares,
                        validation: aiData.validation || (aiData.ai_error ? `[AI Error: ${aiData.ai_error}]` : "Γ£ô")
                    });
